...
class PatientStateMonitor:
    ...
    def update(self, k, next_state):
        ...
        if self._currentState != P.HealthStats.POSTSTROKE and next_state == P.HealthStats.POSTSTROKE:
...
class CohortOutputs:
    ...
    def get_mean_survival_times(self):
        return self._sumStat_survivalTime.get_mean()

    def get_survival_time_CI(self):
        return self._sumStat_survivalTime.get_t_CI(alpha=0.05)
